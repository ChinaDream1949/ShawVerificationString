...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of ShawVerificationString.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/NSString-ShawTool/ShawVerificationString'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'NSString-ShawTool' => '1420218361@qq.com' }
  s.source           = { :git => 'https://github.com/NSString-ShawTool/ShawVerificationString.git', :tag => s.version.to_s }
